...
from src.schemas import UserCreate, UserData, UserBase, VerificationCode, UserLogin, Token
from src.db.repositories import UserRepository
from src.db.models import User
from src.core import get_password_hash, verify_password
from src.cache import verification_cache
from src.smtp import send_verification_email_for_create_account, send_verification_email_for_reset_password
...
class UserService:
    ...
    async def create_user(self, user_data: UserCreate) -> UserData:
        ...
        new_user = await self.repository.add_new_user(new_user)
